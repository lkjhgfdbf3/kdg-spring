...
public class ArticleService {
	...
	public void addArticle() {
		...
		article.setTitle("야구는 흐름' 공식도 안통한 SK 홈런군단의 극적 부활");
		article.setContent(
				"2019 KBO리그 롯데 자이언츠와 SK 와이번스의 경기가 4일 오후 인천 SK 행복드림구장에서 열렸다. 7회말 2사 SK 이재원이 솔로포를 치고 들어오며 축하받고 있다.");
		article.setUserId("1");
		article.setName("김동규");
